...
class Contact implements IRequest {
    ...
    public function __construct($name_id = null, $phone = null, $email = null) {
        if (is_int($name_id)) {
            $this->getContact($name_id);
        } else {
            $this->createContact($name_id, $phone, $email);
        }
    }
     ...
     * @return mixed
     */
    public function createContact($name, $phone = null, $email = null) {
